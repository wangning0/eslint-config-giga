...
module.exports = {
    ...
    root: true, // 当前目录为根目录 不会再寻找 eslint相关的配置
    rules: {
        // 以下rules的顺序以及分类 参考eslint的官方 https://eslint.org/docs/rules/
        ...
        // 禁止 for 循环出现方向错误的循环，比如 for (i = 0; i < 10; i--) 只能出现改形式的for循环
        'for-direction': 'error',
